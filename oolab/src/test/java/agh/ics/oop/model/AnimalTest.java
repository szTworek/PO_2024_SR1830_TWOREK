...
public class AnimalTest {
    ...
    //    czy zwierze ma właściwą orientacje
        ...
        List<MoveDirection> listOfMoves1 = OptionsParser.modify(args);
...
//        czy przemieszcza sie właściwie
        ...
        simulation1.listOfMoves=OptionsParser.modify(args2);
        simulation1.run();
        animal1=animals1.get(0);
        animal2=animals1.get(1);
        ...
        simulation1.listOfMoves=OptionsParser.modify(args);
        simulation1.run();
        simulation1.listOfMoves=OptionsParser.modify(args2);
        simulation1.run();
        animal1=animals1.get(0);
...
//        czy nie wychodzi poza mapę
        ...
        simulation1.listOfMoves=OptionsParser.modify(args3);
        simulation1.run();
...
//       czy dane wejsciowe podane jako tablica znakow sa poprawnie interpretowane
        ...
        simulation1.listOfMoves=OptionsParser.modify(args4);
